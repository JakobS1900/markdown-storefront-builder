...
describe("FR-012: a heading too deep for the host degrades, with a warning", () => {
  const shallow: Target = {
    ...
    capabilities: { maxHeadingLevel: 2, thematicBreak: "***", tables: true, hardBreak: "backslash", localImages: false, strikethrough: true, highlight: true, escapeStyle: "commonmark" },
    sources: {
      ...
      strikethrough: "test fixture",
      highlight: "test fixture",
