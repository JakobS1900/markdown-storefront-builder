...
- [ ] T013 The words are the app's and the wait is the seller's: emit "In stock", "Made to order", "Preorder", "Sold out", and pass the wait through as typed. A seller who wrote "about 2 weeks" must not find it title cased. Research D4.
- [ ] T013a A wait is emitted with `sold-out` like any other mode. "Sold out, back in about two weeks" is a useful sentence and nothing here refuses a wait because of the mode beside it.
